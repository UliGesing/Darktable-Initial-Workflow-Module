...
xgettext InitialWorkflowModule.lua ./Modules/Helper.lua ./Modules/EventHelper.lua ./Modules/GuiAction.lua -d InitialWorkflowModuleExtracted --from-code=UTF-8 --language=Lua
